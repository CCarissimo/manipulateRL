...
Users are modelled as Q-learning agents, with dynamics preferences, and engage in a multi-agent environment described by a Congestion game. The recommender systems are assumed to know the optimal (social welfare) solution and provide recommendations to the agents as state information (see figure below).
